...
export default function LogTable({ columns, rows, keyField = 'id', titleKey, subtitleKey, trailingKey, emptyMessage = 'No records found.' }) {
  if (rows.length === 0) return <EmptyState icon={FileSearch} title="No log entries found" description={emptyMessage} />
