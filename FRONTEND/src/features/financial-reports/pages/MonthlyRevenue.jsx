...
import { CalendarDays, Landmark, Target, TrendingUp } from 'lucide-react'
...
export default function MonthlyRevenue() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <ReportsPageHeader pageTitle="Monthly Revenue" onExport={handleExport} />
      ...
      <RevenueChart
        ...
        description="Collections across recent months, with a 3-month forecast"
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <OutstandingChart variant="bars" title="Revenue by Class" data={data?.revenueByClass} nameKey="className" />
        <PaymentMethodChart title="Revenue by Fee Category" data={data?.revenueByFeeCategory} nameKey="method" />
        <OutstandingChart variant="bars" title="Revenue by Installment" data={data?.revenueByInstallment} nameKey="label" />
      </div>
