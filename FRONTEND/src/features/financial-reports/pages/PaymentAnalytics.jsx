...
import { CircleCheck, CircleX, CreditCard, Undo2 } from 'lucide-react'
...
export default function PaymentAnalytics() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <ReportsPageHeader pageTitle="Payment Analytics" onExport={handleExport} />
      ...
      <RevenueChart
        ...
        description="Transaction volume across the day"
        data={data?.peakHours}
        xKey="label"
