...
export default function ClassesTable({ columns, rows, keyField = 'id', titleKey, subtitleKey, trailingKey, emptyMessage = 'No records found.' }) {
  if (rows.length === 0) return <EmptyState icon={GraduationCap} title="No classes found" description={emptyMessage} />
